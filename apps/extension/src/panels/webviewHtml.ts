...
export async function renderWebviewHtml(webview: vscode.Webview, extensionUri: vscode.Uri, title: string, locale: string): Promise<string> {
  ...
  return html
    ...
    .replace(/<body>/, `<body data-locale="${locale}">`)
